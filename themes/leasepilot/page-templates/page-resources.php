  ...
  <div class="archive-page resource content-padding">
    <div class="main-container">
      <ul id="resource-filter" class="filter-list nostyle-list">
        ...
        ?>
        <li><button data-filter=".<?php echo $term->slug; ?>"><?php echo $term->name; ?></button></li>
        <?php } ?>
      </ul>
      ...
      <?php
        ...
        if ( $resource_query->have_posts() ) :
          ...
          <div class="archive-page-item cell small-12 mobile-6 medium-4 large-4 <?php echo $term[0]->slug; ?>">
            ...
            <h6 class="archive-page-category bold primary-color ff-hn"><?php echo $term[0]->name; ?></h6>
